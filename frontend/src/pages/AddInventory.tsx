...
export default function AddInventory() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Game + Set selectors */}
      <div className="bg-[#111111] border border-[#2a2a2a] rounded-xl p-5 flex flex-wrap gap-4">
      ...
      {setId && (
        <div className="bg-[#111111] border border-[#2a2a2a] rounded-xl overflow-hidden">
          {cardsQuery.isLoading ? (
            <p className="p-5 text-neutral-500 text-sm">Fetching cards from API…</p>
          ) : rows.length === 0 ? (
            <p className="p-5 text-neutral-500 text-sm">No cards found in this set.</p>
          ) : (
            <>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#2a2a2a] text-neutral-500 text-left">
                    ...
                    {rows.map((row, idx) => (
                      <tr
                        ...
                        className={`border-b border-[#2a2a2a] last:border-0 transition-colors ${
                          row.selected ? "bg-red-900/10" : "hover:bg-white/[0.02]"
                        }`}
                      >
                        ...
                        <td className="px-2 py-2 text-neutral-600 text-xs whitespace-nowrap">
                        ...
                        <td className="px-2 py-2">
                          <select
                            ...
                            className="w-full bg-[#1a1a1a] border border-[#333] rounded px-2 py-1 text-xs focus:outline-none focus:border-red-600 disabled:opacity-40"
                          >
                            {VARIANTS.map((v) => (
              ...
              <div className="px-4 py-3 border-t border-[#2a2a2a] flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="bg-red-700 hover:bg-red-600 disabled:opacity-40 rounded px-4 py-2 text-sm font-medium transition-colors"
                  >
                    {status === "loading"
                      ? "Adding…"
